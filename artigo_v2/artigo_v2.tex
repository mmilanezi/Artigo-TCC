...
%=======================================================================
\begin{abstract}
A segurança operacional na aviação civil enfrenta um paradoxo crescente: à medida
que os índices de acidentes diminuem, torna-se mais difícil identificar riscos latentes
...
acurácia de 88,03\%, F1-Score Macro de 0,7414 e ROC-AUC de 0,9516 no conjunto
...
\singlespacing
\begin{abstract}
Civil aviation operational safety faces a growing paradox: as accident rates decline,
...
5-fold cross-validation. The model achieved 88.03\% accuracy, 0.7414 F1 Macro Score,
and 0.9516 ROC-AUC on the test set, classifying flight operations into four
...
O sistema desenvolvido alcançou acurácia de 88,03\%, F1-Score Macro de 0,7414
e ROC-AUC de 0,9516, classificando operações aéreas em quatro categorias
...
fundamentação teórica sobre segurança operacional, avaliação de risco pré-voo e
as técnicas de aprendizado de máquina empregadas; a Seção~3 descreve o
desenvolvimento do sistema; a Seção~4 detalha a metodologia adotada; a
Seção~5 apresenta e discute os resultados obtidos; e a Seção~6 traz as conclusões.
...
A acurácia de 88,03\% indica que o ensemble classifica corretamente a grande
maioria das operações avaliadas. Entretanto, dado o desbalanceamento da
Classe 2, a métrica mais relevante para análise é o F1-Score Macro de 0,7414, que
...
O ROC-AUC de 0,9516 é o resultado mais expressivo: ele indica que, em 95,16\%
...
0,8247 do ensemble superou todos os modelos treinados isoladamente, corroborando
...
Os resultados obtidos --- acurácia de 88,03\%, F1-Score Macro de 0,7414 e
ROC-AUC de 0,9516 --- demonstram que o ensemble é capaz de classificar
